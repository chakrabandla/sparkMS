...
def psm_table(psm, pep, out_path):
    ...
    df_psm_exploded = df_psm.select(Fields.USI, explode(Fields.ADDITIONAL_ATTRIBUTES).alias(Fields.ADDITIONAL_ATTRIBUTES), Fields.EXTERNAL_PROJECT_ACCESSION, Fields.ASSAY_ACCESSION, Fields.PEPTIDE_SEQUENCE, Fields.MODIFIED_PEPTIDE_SEQUENCE, Fields.CHARGE, Fields.PRECURSOR_MASS, Fields.IS_DECOY)
